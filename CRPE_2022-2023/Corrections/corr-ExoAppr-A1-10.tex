...
\begin{enumerate}
   ...
   \bm{la probabilité d'être donneur universel est de 0,06.}
   ...
   \bm{la probabilité d'être receveur universel est de 0,03.}
   ...
   \bm{la probabilité de pouvoir donner a une personne de groupe B rhésus positif est de 0,52.}
   ...
   \bm{Pour une personne du groupe O, la probabilité d'être donneur universel est d'environ 0,14.}
   ...
   \bm{Au 1\up{er} janvier 2016, il y avait environ 2\,593\,040 donneurs universels.} \\ [2mm]
   \item $\dfrac{43\,217\,325}{66\,627\,602}\times100 \approx64,86.$ \\ [2mm]
   \bm{Au 1\up{er} janvier 2016, environ 65\,\% de la population pouvait donner son sang.}
 \end{enumerate}
