...
\begin{enumerate}
      ...
      \end{itemize}
      On a alors KA = KB, et IA = IB, donc, \bm{la droite (KI) est la médiatrice du segment [AB].}
      \item
      \begin{itemize}
      ...
      \end{itemize}
      D'où : \bm{les points C, O, H sont alignés.}
      \item
      \begin{itemize}
      ...
      \bm{le quadrilatère IKCO est un trapèze.}
   \end{enumerate}
