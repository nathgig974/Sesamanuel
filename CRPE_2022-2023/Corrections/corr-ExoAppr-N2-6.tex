...
\begin{enumerate}
   ...
   \begin{enumerate}
      ...
      \hspace*{4.35cm} $=x^2-1-x^2+4 =$ \bm{3}.
      \item pour calculer $297\times295-298\times294$, on utilise le résultat précédent appliqué à $x =296$ et on trouve \bm{$297\times295-298\times294 =3$}.
      \end{enumerate}
   ...
   \bm{Si $a$ et $b$ sont deux nombres consécutifs, alors leur somme est égale à la différence de leurs carrés.}
\end{enumerate}
