...
\textcolor{PartieGeometrie}{\sffamily\bfseries Cahier de compétences} : chapitre 10, exercices 1 à 24.
...
\serie{Propriétés des parallélogrammes} %%%%%%%%%%%
...
\serie{Construction de parallélogrammes} %%%%%%%%%%%%%
...
\begin{exercice} %5
   Construire en vraie grandeur les parallélogrammes schématisés ci-dessous (longueurs en cm).
   \begin{center}
      \includegraphics[width=7cm]{Parallelogramme_exo}
   \end{center}
\end{exercice}
...
\serie{Démonstrations} %%%%%%%%%%%%%%%

\bigskip


\begin{exercice} %8
   {\textcolor{G1}{\bf 1)}} Tracer le cercle $(C_1)$ de centre $O$ de rayon \ucm{3,5}.
   \begin{enumerate}
      \setcounter{enumi}{1}
...
\begin{exercice} %8
   {\textcolor{G1}{\bf 1)}} Tracer un triangle équilatéral $ABC$ de côté \ucm{5}.
   \begin{enumerate}
   \setcounter{enumi}{1}
...
\enigme[Les puzzles de Sam Loyd]
...
Sam Loyd (1841-1911) était un mathématicien américain adepte de casse-têtes mathématiques et d'échec. Il est à l'origine de milliers de casse-têtes publiés notamment dans des journaux. On considère l'énigme \og The royal road to mathematics \fg{}, issu du {\it Sam Loyd's cyclopedia of 5000 puzzles tricks and conundrums with answers}, page 60.
   \begin{center}
      \includegraphics[width=9cm]{Sam_loyd} \quad \includegraphics[width=5cm]{Sam_loyd_texte}
   \end{center}
   \begin{multicols}{2}
